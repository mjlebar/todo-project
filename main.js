...
/***/ "./src/init-projects.js":
/*!******************************!*\
  !*** ./src/init-projects.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"initProjects\": () => (/* binding */ initProjects)\n/* harmony export */ });\n/* harmony import */ var _project_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./project.js */ \"./src/project.js\");\n/* harmony import */ var _todo_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./todo.js */ \"./src/todo.js\");\n\n\n\nfunction initProjects() {\n  const projects = [];\n  const mainProject = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.project)(\"Main\");\n  const move = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.project)(\"Move\");\n  const guitar = (0,_project_js__WEBPACK_IMPORTED_MODULE_0__.project)(\"Guitar\");\n  projects.push(mainProject);\n  projects.push(move);\n  projects.push(guitar);\n\n  const clean = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Clean apartment\",\n    `Take out trash, do dishes, sweep`,\n    \"9/5/2022\",\n    \"Low\",\n    false\n  );\n  const feed = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Feed the cat\",\n    `1/4 cup dry food & 1 can wet food/day`,\n    \"9/2/2022\",\n    \"High\",\n    true\n  );\n  const shop = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Buy groceries\",\n    `Need milk, cheese, snacks, cat food`,\n    \"9/8/2022\",\n    \"Low\",\n    false\n  );\n  mainProject.addTodo(clean);\n  mainProject.addTodo(feed);\n  mainProject.addTodo(shop);\n\n  const hire = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Hire movers\",\n    \"Get estimate from movers and confirm a date\",\n    \"9/9/2022\",\n    \"Medium\",\n    true\n  );\n  const moveStuff = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Move small stuff\",\n    `Move stuff I don't need movers for, eg book boxes`,\n    \"9/15/2022\",\n    \"Medium\",\n    false\n  );\n  const newAdd = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Change addresses\",\n    \"Register address change with USPS, Illinois BMV, etc.\",\n    \"10/1/2022\",\n    \"Low\",\n    false\n  );\n\n  move.addTodo(hire);\n  move.addTodo(moveStuff);\n  move.addTodo(newAdd);\n\n  const stairway = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Learn to play Stairway to Heaven\",\n    \"By Led Zeppelin\",\n    \"10/1/2022\",\n    \"High\",\n    true\n  );\n  const pull = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Learn to play Pull Me Under\",\n    \"By Dream Theater\",\n    \"10/1/2022\",\n    \"High\",\n    true\n  );\n  const tornado = (0,_todo_js__WEBPACK_IMPORTED_MODULE_1__.todo)(\n    \"Learn to play Tornado of Souls\",\n    \"By Megadeth\",\n    \"10/1/2022\",\n    \"High\",\n    true\n  );\n\n  guitar.addTodo(stairway);\n  guitar.addTodo(pull);\n  guitar.addTodo(tornado);\n\n  return projects;\n} //Just loads up the page with some projects\n\n\n\n\n//# sourceURL=webpack://todo-project/./src/init-projects.js?");
